"""
The mmcv.ops.points_sampler module provides a set of points sampling methods for point cloud data. 
It includes implementations of different sampling strategies, such as D-FPS (Distance-based Farthest Point Sampling), 
F-FPS (Feature-based Farthest Point Sampling), and FS (a combination of both). The module also provides a utility function to calculate the square distance between point features.
"""
